...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/search?name=Mo', function () {
    it('Retorna a lista de chocolates que começa com "Mo"', async function () {
      const output = [
        {
          "id": 3,
          "name": "Mon Chéri",
  ...
  describe('Usando o método PUT em /chocolates/1', function () {
    it('Retorna o chocolate com ID 1 atualizado com as novas informações', async function () {
      const input = {
