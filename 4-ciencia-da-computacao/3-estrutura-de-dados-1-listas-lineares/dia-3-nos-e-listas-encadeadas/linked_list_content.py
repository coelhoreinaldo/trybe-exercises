...
if __name__ == "__main__":
    ...
    print(linked_list)  # LinkedList(len=1 value=Node(value=1 next=None))
    ...
    print(linked_list)  # LinkedList(len=1 value=Node(value=5 next=None))

    linked_list.insert_at(6, 1)
    linked_list.insert_at(7, 2)
    linked_list.insert_at(8, 3)
    linked_list.insert_at(9, 4)
    print(linked_list.get_element_at(3))  # Node(value=8 next=None)
